...
public interface UniteRepository extends JpaRepository<Unite, Long>{
	...
	@Query("SELECT n.unite.code,n.note FROM Note n INNER JOIN n.unite u INNER JOIN n.etudiant e WHERE n.situation = false AND n.annee=:annee AND e.numero = :etudiant AND n.session='normale'")
